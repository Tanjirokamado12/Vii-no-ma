...
const filesToCopy = ['assets/v1025first.txt'];
...
// Assign destDir based on the file name
let destDir;
if (fileName === 'v1025first.txt') {
    destDir = v1025Dir;
} else {
    destDir = __dirname; // Fallback to the current directory or specify another valid default directory
}
