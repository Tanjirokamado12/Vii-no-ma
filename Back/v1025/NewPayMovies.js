...
const inputFilePath = path.join(__dirname, '../../files/v1025/NewPayMovies.txt'); // Path to input text file
const outputFilePath = path.join(__dirname, '../../v1025/url3/pay/list/New/all.xml'); // Path to output XML file
