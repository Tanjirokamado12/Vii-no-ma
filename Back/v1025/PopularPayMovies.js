...
const inputFilePath = path.join(__dirname, '../../files/v1025/PopularPayMovies.txt'); // Path to input text file
const outputFilePath = path.join(__dirname, '../../v1025/url3/pay/list/popular/all.xml'); // Path to output XML file
...
function parseAndGenerateXML(inputFile, outputFile) {
    fs.readFile(inputFile, 'utf8', (err, data) => {
        ...
        let xmlContent = `<PopularPayMovies>\n  <ver>1</ver>\n`;
