...
function saveXmlFiles(movieData) {
    Object.keys(movieData).forEach(typeKey => {
        ...
        const outputDir = path.join(__dirname, '../../v512/url1/list/new/'); // Output directory
...
// Main execution
const inputFile = path.join(__dirname, '../../files/v512/GenreNewMovies.txt');
