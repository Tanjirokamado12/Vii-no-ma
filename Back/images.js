...
// Define target directories for v770
const v770Targets = {
  roomTargetDir: path.join(__dirname, '../v770/url1/special'),
  miiTargetDir: path.join(__dirname, '../v770/url1/mii'),
  deliveryTargetDir: path.join(__dirname, '../v770/url1/delivery'),
  wallTargetDirs: [path.join(__dirname, '../v770/url1/wall')],
  couponTargetDir: path.join(__dirname, '../v770/url1/coupon'),
  pictureTargetDir: path.join(__dirname, '../v770/url1/picture'),
  linkTargetDir: path.join(__dirname, '../v770/url1/urllink'),
  categoryTargetDirs: [path.join(__dirname, '../v770/url1/list/category/img')],
  payWallTargetDirs: [path.join(__dirname, '../v770/url3/pay/wall')],
};
...
// Copy files for v770
copyFiles(wallSourceDir, v770Targets.wallTargetDirs);
copyFiles(payWallSourceDir, v770Targets.payWallTargetDirs);
copyFiles(categorySourceDir, v770Targets.categoryTargetDirs);
copyFilesRecursively(roomSourceDir, v770Targets.roomTargetDir);
copyFiles(miiSourceDir, [v770Targets.miiTargetDir]);
copyFiles(couponSourceDir, [v770Targets.couponTargetDir]);
copyFiles(deliverySourceDir, [v770Targets.deliveryTargetDir]);
copyFiles(pictureSourceDir, [v770Targets.pictureTargetDir]);
copyFiles(linkSourceDir, [v770Targets.linkTargetDir]);
