...
const inputFileName = '../Files/v1025/SpContact.txt'; // Replace with your source file name
...
fs.readFile(inputFileName, 'utf8', (err, data) => {
  ...
  <contact>${currentContact}</contact>
                ...
                const outputFilePath = path.join(__dirname, `../../v1025/url1/special/${currentSpPageid}/contact.xml`);
