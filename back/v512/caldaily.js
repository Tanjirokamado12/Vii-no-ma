...
const calDailyFilePath = path.join(__dirname, '../../Files/v512/caldaily.txt');
const outputDir = path.join(__dirname, '../../v512/url1/caldaily/');
...
for (let date = startDate; date <= endDate; date.setDate(date.getDate() + 1)) {
  ...
  <trivia>
    ...
    <upddt>2025-02-24T14:58:50.664Z</upddt>
</CalDaily>`;
