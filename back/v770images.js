...
const IntroTargetDir = path.join(__dirname, '../v770/url1/intro');
const PayIntroTargetDir = path.join(__dirname, '../v770/url3/pay/intro');
const PayCategoryTargetDir = path.join(__dirname, '../v770/url3/pay/list/category/img/');
