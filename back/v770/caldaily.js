...
const inputFilePath = path.join(__dirname, '../../files/v770/Caldaily.txt'); // Input file path
const values = readValuesFromFile(inputFilePath);

// Generate XML files for all days from 2025 to 2026
const outputDirectory = path.join(__dirname, '../../v770/url1/caldaily'); // Output directory path
