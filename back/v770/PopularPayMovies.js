...
const inputFilePath = path.join(__dirname, '../../files/v770/PopularPayMovies.txt'); // Path to input text file
const outputFilePath = path.join(__dirname, '../../v770/url3/pay/list/popular/all.xml'); // Path to output XML file
